...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/images/favicon-32x32.png')}}" type="image/x-icon">
    <meta name="theme-color" content=" #04f428">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="Surfside Media">
    <meta name="msapplication-TileImage" content="{{ asset('assets/images/favicon-32x32.png')}}">
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{route('app.index')}}" class="nav-link menu-title">Doma</a></li>
                                            <li><a href="{{route('shop.index')}}" class="nav-link menu-title">Zboží</a></li>
                                            <li><a href="{{route('cart.index')}}" class="nav-link menu-title">Košík</a></li>
                                        ...
                                        <div class="onhover-div profile-dropdown">
                                            <ul>
                                                ...
                                                @auth
                                                    ...
                                                    <li>
                                                        <a href="{{route('admin.index')}}" class="d-block">Nástěnka</a>
                                                    </li>
                                                    @else
                                                    <li>
                                                        <a href="{{route('user.index')}}" class="d-block">Můj účet</a>
                                                    </li>
                                                    @endif
                                                    <li>
                                                        <a href="{{route('logout')}}" onclick="event.preventDefault();document.getElementById('frmlogout').submit();" class="d-block">Odhlásit se</a>
                                                ...
                                                @else 
                                                <li>
                                                        <a href="{{route('login')}}" class="d-block">Přihlásit se</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{route('register')}}" class="d-block">Registrovat se</a>
                                                    </li>   
                                                @endauth
                                                @endif
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>Telefonní číslo:</b> <span class="font-light">+420 253 622 841</span></span>
                                </li>
                                <li>
                                    <span><b>Adresa:</b><span class="font-light"> Czech Republic, Fiktivní Ulice 101,  Fiktivní Město, PSČ: 97623</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@BoardPlay.cz</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    <div class="col-md-6">
                        <ul>
                            <li class="font-dark">Příjmáme :</li>
                            <li>
                                <a href="javascript:void(0)">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2023, Šimon Jetmar - Informační managment</p>
                    </div>
                </div>
            </div>
        </div>
